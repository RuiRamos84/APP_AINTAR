...
const ForgotPasswordPage = () => {
  ...
  const formContent = (
    <>
      ...
      {sent ? (
        <Stack spacing={3}>
          <Alert severity="success" icon={<EmailIcon />} sx={{ borderRadius: 2 }}>
            <Typography variant="body2" fontWeight={600}>Email enviado com sucesso!</Typography>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          <Stack spacing={3}>
            ...
            <TextField
              fullWidth label="Endereço de Email" type="email" autoComplete="email"
