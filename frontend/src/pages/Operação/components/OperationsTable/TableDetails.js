                        ...
                        {isRamaisView && (
                            <>
                                <Grid size={{ xs: 12, sm: 6 }}>
                                    ...
                                    <Typography variant="body1">{row.execution || "Não definida"}</Typography>
                                </Grid>
                                <Grid size={{ xs: 12, sm: 6 }}>
                                    <Typography variant="body2" color="text.secondary">Data Limite</Typography>
                                    <Typography variant="body1">{row.limitdate || "Não definida"}</Typography>
                                </Grid>
                            </>
                        )}
                    </Grid>
            ...
            <Table size="small">
                <TableBody>
                    ...
                    <TableRow>
                        ...
                        <TableCell>{row.memo || "Sem observações"}</TableCell>
                    </TableRow>
                    {isRamaisView && (
                        <>
                            <TableRow>
                                ...
                                <TableCell>{row.execution || "Não definida"}</TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell component="th" scope="row" sx={{ fontWeight: 'bold' }}>
                                    Data Limite
                                </TableCell>
                                <TableCell>{row.limitdate || "Não definida"}</TableCell>
                            </TableRow>
                        </>
                    )}
                </TableBody>
