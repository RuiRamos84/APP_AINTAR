                        ...
                        <Grid container spacing={2}>
                            <Grid xs={12} md={4}>
                                <Box>
                                    ...
                                    <Typography>{entity.apa_data_ini ? formatDate(entity.apa_data_ini) : 'N/D'}</Typography>
                                </Box>
                            </Grid>
                            <Grid xs={12} md={4}>
                                <Box>
                                    <Typography variant="caption" color="text.secondary">Validade</Typography> 
                                    <Typography>{entity.apa_data_fim ? formatDate(entity.apa_data_fim) : 'N/D'}</Typography>
                                </Box>
                            </Grid>
                            <Grid xs={12} md={4}>
                                <Box>
