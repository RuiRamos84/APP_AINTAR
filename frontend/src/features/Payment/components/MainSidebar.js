...
const MainSidebar = () => {
    ...
    useEffect(() => {
        ...
        if (user && permissionsInitialized) {
            // getAccessibleSidebarItems agora retorna o array diretamente
            const accessibleItems = getAccessibleSidebarItems;
            // Garantir que o que é definido é sempre um array
            setMenuItems(Array.isArray(accessibleItems) ? accessibleItems : []);
