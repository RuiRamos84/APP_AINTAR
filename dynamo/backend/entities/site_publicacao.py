ENTITY = {
    ...
    "db": {
        "readView":  "vbl_site_publicacao",
        "writeView": "vbf_site_publicacao",
        "pkField":   "pk",
    },
    ...
    "fields": [
        ...
        {"key": "subtipo",        "label": "Subtipo",          "type": "text",   "readonly": True},
    ...
    "listView": {
        "columns":     ["titulo", "tipo", "numero", "ano", "data_publicacao", "ativo"],
