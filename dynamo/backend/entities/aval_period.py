ENTITY = {
    ...
    "labelPlural": "Períodos de Avaliação",
    "icon":        "CalendarCheck",

    "db": {
        "readView":  "vbl_aval_period",
        "writeView": "tb_aval_period",
        "pkField":   "pk",
    },
    ...
    "formView": {
        "sections": [
            {"title": "Período", "fields": ["year", "descr", "active", "data"], "cols": 2},
        ],
    },
}
