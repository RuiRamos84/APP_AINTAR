ENTITY = {
    "key":         "instalacao_energyread",
    "label":       "Leitura de Energia",
    "labelPlural": "Leituras de Energia",
    "icon":        "Zap",

    "db": {
        "readView":  "vbl_instalacao_energyread",
        "writeView": "tb_instalacao_energyread",
        "pkField":   "pk",
    },
    ...
    "listView": {
        "columns":     ["tb_instalacao", "data", "valor_vazio", "valor_ponta", "valor_cheia"],
    ...
    "formView": {
        "sections": [
            {"title": "Leitura Energia", "fields": ["tb_instalacao", "data", "valor_vazio", "valor_ponta", "valor_cheia"], "cols": 2},
        ],
    },
}
