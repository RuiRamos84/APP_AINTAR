export default {
  ...
  db: { readView: 'vbl_task', writeView: 'tb_task', pkField: 'pk' },
  ...
  formView: {
    sections: [
      { title: 'Tarefa', fields: ['name', 'ts_priority', 'ts_notestatus'], cols: 3 },
      { title: 'Datas',  fields: ['when_start', 'when_stop'],              cols: 2 },
