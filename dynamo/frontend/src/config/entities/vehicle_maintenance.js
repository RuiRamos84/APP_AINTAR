export default {
  ...
  db: { readView: 'vbl_vehicle_maintenance', writeView: 'vbf_vehicle_maintenance', pkField: 'pk' },
  ...
  formView: {
    sections: [
      { title: 'Manutenção', fields: ['tb_vehicle', 'tt_maintenancetype', 'data', 'price'], cols: 2 },
