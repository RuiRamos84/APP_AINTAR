export default {
  key: 'site_documento', label: 'Documento do Site', labelPlural: 'Documentos do Site', icon: 'FileDown',
  db: { readView: 'vbl_site_documento', writeView: 'vbf_site_documento', pkField: 'pk' },
  ...
  listView: { columns: ['titulo', 'categoria', 'subcategoria', 'ano', 'ativo'], defaultSort: { field: 'ordem', dir: 'asc' }, searchable: true },
  formView: { sections: [
