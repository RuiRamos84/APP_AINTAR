export default {
  ...
  db: { readView: 'vbl_etar', writeView: 'vbf_etar', pkField: 'pk' },
  ...
  formView: {
    sections: [
      { title: 'Identificação',          fields: ['nome', 'tt_tipoetar', 'tt_freguesia', 'subsistema'], cols: 2 },
      { title: 'Capacidade',             fields: ['nivel_tratamento', 'pop_dimen', 'pop_servida', 'agua_tratada'], cols: 2 },
      { title: 'Licenciamento & Energia',fields: ['apa_licenca', 'ener_cpe', 'ativa'], cols: 3 },
