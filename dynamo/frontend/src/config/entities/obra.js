export default {
  ...
  db: { readView: 'vbl_obra', writeView: 'vbf_obra', pkField: 'pk' },
  ...
  listView: {
    columns:     ['nome', 'tt_tipoobra', 'tb_instalacao', 'data_prevista', 'valor_estimado'],
  ...
  formView: {
    sections: [
      { title: 'Identificação', fields: ['nome', 'tt_tipoobra', 'tb_instalacao', 'tt_urgencia'], cols: 2 },
      { title: 'Calendário',    fields: ['data_prevista', 'data_obra_inicio', 'data_obra_fim'],   cols: 3 },
      { title: 'Valores (€)',   fields: ['valor_estimado', 'valor_exec_aintar', 'valor_exec_subsidio', 'valor_exec_municipio'], cols: 2 },
      { title: 'Notas',         fields: ['aviso', 'memo'], cols: 1 },
    ],
  },
