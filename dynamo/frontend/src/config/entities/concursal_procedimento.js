export default {
  key: 'concursal_procedimento', label: 'Procedimento Concursal', labelPlural: 'Procedimentos Concursais', icon: 'ClipboardCheck',
  db: { readView: 'vbl_concursal_procedimento', writeView: 'vbf_concursal_procedimento', pkField: 'pk' },
  ...
  listView: { columns: ['codigo_bep', 'carreira', 'categoria', 'data_abertura', 'data_encerramento', 'ativo', 'total_candidaturas'], defaultSort: { field: 'data_abertura', dir: 'desc' }, searchable: true },
  formView: { sections: [
  ...
  relations: {
    candidaturas: { type: 'hasMany', entity: 'concursal_candidatura', foreignKey: 'tb_procedimento', label: 'Candidaturas', icon: 'UserPlus' },
  },
  detailView: { tabs: [
