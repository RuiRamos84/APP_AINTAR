export default {
  ...
  db: { readView: 'vbl_expense', writeView: 'tb_expense', pkField: 'pk' },
  ...
  fields: [
    ...
    { key: 'tb_instalacao',       label: 'Instalação',    type: 'relation', relation: { type: 'belongsTo', entity: 'instalacao', displayField: 'nome' } },
    { key: 'tt_expensetypevalue', label: 'Tipo (desc.)',  type: 'text',   readonly: true },
  ...
  formView: {
    sections: [
      { title: 'Despesa', fields: ['data', 'tt_expensetype', 'tb_instalacao', 'valor', 'ts_client'], cols: 2 },
