export default {
  key: 'operacaometa', label: 'Meta de Operação', labelPlural: 'Metas de Operação', icon: 'CalendarClock',
  db: { readView: 'vbl_operacaometa', writeView: 'vbf_operacaometa', pkField: 'pk' },
  ...
  listView: { columns: ['tt_operacaomodo', 'tb_instalacao', 'tt_operacaodia', 'tt_operacaoaccao', 'ts_operador1'], defaultSort: { field: 'pk', dir: 'asc' }, searchable: true },
  formView: { sections: [{ title: 'Meta', fields: ['pk_instalacao', 'pk_operacaoaccao', 'tt_operacaomodo', 'tt_operacaodia', 'pk_operador1'], cols: 2 }]},
  custom: null,
}
