export default {
  ...
  db: { readView: 'vbl_contract', writeView: 'vbf_contract', pkField: 'pk' },
  ...
  formView: {
    sections: [
      { title: 'Contrato', fields: ['ts_entity', 'start_date', 'stop_date', 'tt_contractfrequency'], cols: 2 },
      { title: 'Morada',   fields: ['address', 'postal', 'nut3', 'nut4'],                            cols: 2 },
    ],
  },
