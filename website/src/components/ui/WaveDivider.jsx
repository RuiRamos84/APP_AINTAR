...
export default function WaveDivider({ direction = 'down', color = '#ffffff' }) {
  ...
  const layer1Path = isDown
    ...
    ? 'M0,32 C180,52 360,12 540,32 C720,52 900,12 1080,32 C1260,52 1440,12 1620,32 C1800,52 1980,12 2160,32 C2340,52 2520,12 2700,32 C2880,52 2880,64 0,64 Z'
    // preenche para cima (light → dark)
    : 'M0,32 C180,12 360,52 540,32 C720,12 900,52 1080,32 C1260,12 1440,52 1620,32 C1800,12 1980,52 2160,32 C2340,12 2520,52 2700,32 C2880,12 L2880,0 L0,0 Z'
