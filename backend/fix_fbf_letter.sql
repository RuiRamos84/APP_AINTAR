-- Corrigir função fbf_letter - ADICIONAR parâmetro pnemission_date que estava faltando
-- A função tentava usar pnemission_date mas o parâmetro não existia
...
CREATE OR REPLACE FUNCTION aintar_server_dev.fbf_letter(
    ...
    pnemission_date timestamp without time zone,
    pnsubject text,
