"""
Aplica a migração 36_consentimento_biometrico.sql (sessão de 2026-07-16 —
RGPD biométrico, Fase 1 do plano "correcto → excelente") aos dois schemas
que partilham a mesma base de dados/host: aintar_server_dev (dev) e
...
Uso (a partir da pasta backend/):
    venv\\Scripts\\python.exe app\\sql\\rh\\apply_consentimento_biometrico.py
"""
import os
import sys
import psycopg2
...
MIGRATIONS = [
    '36_consentimento_biometrico.sql',
]
...
def main():
    ...
    print('\nConcluído — migração 36 (consentimento biométrico) aplicada com sucesso em ambos os schemas.')
